...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    rentovaAuthUserSubject.add(
      RentovaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RentovaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RentovaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RentovaAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    rentovaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
