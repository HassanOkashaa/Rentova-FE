...
class PropertyDetailsPageWidget extends StatefulWidget {
  /// When a user clicks on a property from the explore page they enter this
  /// page
                          ...
                          child: Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'mh9vpanz' /* Super Deluxe Villa in Marassi ... */,
                                  ),
                              ...
                              Align(
                                ...
                                child: ToggleIcon(
                                  onPressed: () async {
                                    safeSetState(() => FFAppState().selected =
                                        !FFAppState().selected);
                                  },
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'x9h1glc4' /* 3 floor villa in North Coast, ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelSmall
                                    .override(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '4u6gasi7' /* 3 FLOOR VILLA IN THE HEART OF ... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'lgwqavh2' /* What this place offers */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () {
                                    print('showAmenitiesButton pressed ...');
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    'etly4bbq' /* Show all amenities */,
                                  ),
