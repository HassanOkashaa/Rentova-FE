...
import 'guest_profile_model.dart';
export 'guest_profile_model.dart';

class GuestProfileWidget extends StatefulWidget {
  /// Profile tab when a user isn't logged in yet
...
class _GuestProfileWidgetState extends State<GuestProfileWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestProfileModel());
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'srac3stl' /* Log in to start renting. */,
                          ),
                          style:
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'e7u4hn9d' /* Once you login, you'll find yo... */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Poppins',
